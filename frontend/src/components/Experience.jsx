        ...
        <div className="animate-on-scroll opacity-0">
          ...
          <div className="space-y-16">
            {portfolioData.experience.map((exp, index) => (
              ...
              >
                <div className="absolute -left-[9px] top-0 w-4 h-4 bg-white border-2 border-gray-300 rounded-full group-hover:border-black group-hover:bg-black transition-all duration-300" />
                ...
                <h4 className="text-2xl font-light tracking-tight mb-2">
                  {exp.title}
                </h4>
